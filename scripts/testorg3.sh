...
# chaincode requests through the mb peers to check that mb was
...
# Query chaincode on peer0.mb, check if the result is 90
echo "Querying chaincode on peer0.mb..."
chaincodeQuery 0 3 90

# Invoke chaincode on peer0.vw, peer0.bmw, and peer0.mb
echo "Sending invoke transaction on peer0.vw peer0.bmw peer0.mb..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.mb, peer0.bmw, peer0.vw check if the result is 80
...
echo "Querying chaincode on peer0.bmw..."
